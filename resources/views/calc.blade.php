                    ...
                    <div class="padding">
                        <div id="hashNav">
                            <div class="flex"><p data-href="1" data-toggle="progressbar" data-target="#myProgressbar"
                                                 data-value="0"
                                                 class="link_href hidden_nav"
                                ><img src="{{asset('uploads/')}}/svg/arrow.svg" alt="">В
                                    начало</p>
                                <p data-href="2" data-toggle="progressbar" data-target="#myProgressbar" data-value="20"
                                   class="link_href hidden_nav"
                                ><img src="{{asset('uploads/')}}/svg/arrow.svg" alt="">Модели</p>
                                <p data-href="3" data-toggle="progressbar" data-target="#myProgressbar" data-value="60"
                                   class="link_href hidden_nav"
                                ><img src="{{asset('uploads/')}}/svg/arrow.svg" alt="">Поломки</p>
                                <p data-href="4" data-toggle="progressbar" data-target="#myProgressbar" data-value="60"
                                   class="link_href hidden_nav displayhash"
                                ><img src="{{asset('uploads/')}}/svg/arrow.svg" alt="">Дисплей
                                </p></div>
                        </div>
                            ...
                            <div class="btn-groups">
                                ...
                                @foreach($cats as $cat)
                                    ...
                                    <div class="block">
                                        ...
                                        >
                                        <button data-btn="{{$cat->name}}"
                                                data-toggle="progressbar"
                                                data-target="#myProgressbar"
                                                data-value="{{$cat->devices->isNotEmpty() ? 30 : 'finish'}}"
                                                class="nav_btn device_target"
                                        >{{$cat->name}}
                                        </button>
                                    </div>
                        ...
                        @foreach ($cats as $cat)
                            ...
                            @if ($cat->devices->isNotEmpty())
                                ...
                                <div data-view="{{$cat->name}}_view" data-lvl="2" class="block_iphone views faded">
                                    <h2><span
                                                class="bold"
                                        >Выберите модель</span>
                                    </h2>
                                    <div class="wrapper">
                                        <div class="btn-groups">
                                            ...
                                            @foreach ($cat->devices->sortBy('order') as $device)
                                                ...
                                                <div class="block">
                                                    <button data-btn="{{$cat->name}}_breaking" data-toggle="progressbar"
                                                            ...
                                                            class="nav_btn model_target active"
                                                    >{{$device->name}}
                                                    </button>
                                                </div>
                                    ...
                                    <!-- <div class="what_model"><p class="callback_what_model">Не знаете, какая у вас модель?</p></div> -->
                                        <div class="disnone">
                                            <div class="popup_what_model popup_window">
                                                <div class="box-modal_close arcticmodal-close close">
                                                    <span>Закрыть</span></div>
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        <div class="form">
                                                            <div class="zag">Как определить модель iPhone?<span></span>
                                                            </div>
                                                            <p class="desc main">Посмотрите, какой номер указан на
                                                                задней крышке вашего устройства внизу, и
                                                                ...
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    @foreach ($cat->devices as $device)
                                                                        @if ($device->subcategories != ' ' && $device->subcategories != '')
                                                                            ...
                                                                            <div class="flex">
                                                                                <div class="left">
                                                                                    <button data-btn="{{$cat->name}}_breaking"
                                                                                            data-toggle="progressbar"
                                                                                            data-target="#myProgressbar"
                                                                                            data-value="60"
                                                                                            data-model="{{$device->id}}"
                                                                                            class="nav_btn model_target"
                                                                                    >{{$device->name}}
                                                                                    </button>
                                                                                </div>
                                                                                <div class="right">
                            ...
                            @else
                                ...
                                <div data-view="{{$cat->name}}_view" data-lvl="2" class="block_imac views faded">
                                    <div class="form">
                                        <form id="frm2"
                                              method="post"
                                              action="{{ asset('mail.php') }}"
                                              class="contactform2"
                                        >
                                            <div class="zag">{{$cat->stub}}</div>
                                            <div class="text">Оставьте свой номер, мы подскажем стоимость и время
                                                работ.
                                            </div>
                                            <input id="phone" type="text" name="phone" placeholder="+7 (___) ___-__-__"
                                                   class="form-control phone validate[required]"
                                            ><input name="action" value="Получить скидку"
                                                    type="hidden"
                                            >
                                            <button>Узнать стоимость</button>
                                            <div id="confidential" class="minconf">Нажимая на кнопку
                                                «<span class="textbtn"></span>», я даю <a
                                                        href="/politics.pdf" target="_blank"
                            ...
                            >
                                        ...
                                        <div data-device="{{$device->id}}" class="btn-groups">
                                            ...
                                            <div class="block flex-justify-center">
                                                ...
                                                @foreach ($device->breakings as $breaking)
                                                    <?php
                                                    /** @var \App\Models\Breaking $breaking */
                                                    ...
                                                    @if ($breaking->is_additional_window())
                                                        ...
                                                        <button data-btn="{{$device->name}}_iphone_display"
                                                                data-toggle="progressbar"
                                                                data-target="#myProgressbar"
                                                                data-value="80"
                                                                data-price="b6"
                                                                data-breaking="{{$breaking->name}}"
                                                                class="nav_btn polomka_target crushglass"
                                                        >{{$breaking->name}}
                                                        </button>
                                ...
                                <div class="form">
                                    <form id="frm2" method="post" action="{{ asset('mail.php') }}" class="contactform2">
                                        ...
                                        <div class="text">Оставьте свой номер, мы подскажем стоимость и время работ.
                                        </div>
                                        <input id="phone" type="text" name="phone" placeholder="+7 (___) ___-__-__"
                                               class="form-control phone validate[required]"
                                        ><input name="action" value="Получить скидку"
                            ...
                            @foreach ($cat->devices as $device)
                                ...
                                @foreach ($device->breakings as $breaking)
                                    ...
                                    @if ($breaking->is_additional_window())
                                        ...
                                        <div data-view="{{$device->name}}_iphone_display_view"
                                             data-lvl="4"
                                             class="block_iphone_display views faded"
                                        ><h2>
                                                <span>Ваш дисплей исправен? <br>Дисплей считается исправным, если:</span>
                                            </h2>
                                            <ul>
                                                <li>Отсутствуют дефекты изображения (пятна, битые пиксели, полосы на
                                                    экране).
                                                </li>
                                            ...
                                            <div class="row ">
                                                <div class="col-xs-12 ">
                                                    <div class="imgsdis"><p class="text">Исправный диплей</p>
                                                        <img src="{{asset('uploads/')}}/iftrue.jpg"
                                                             alt=""
                                                             class="img-responsive"
                                                        ><img
                                                                src="{{asset('uploads/')}}/iftrue2.jpg"
                                                                alt=""
                                                                class="img-responsive "
                                                        ></div>
                                                    <div class="imgsdis"><p class="text">Неисправный диплей</p><img
                                                                ...
                                                                class="img-responsive"
                                                        ><img
                                                                src="{{asset('uploads/')}}/iffalse2.jpg"
                                                                alt=""
                                                                class="img-responsive"
                                                        ></div>
                                                </div>
                                                ...
                                                <div class="col-xs-12">
                                                    <div class="btn-groups newgroups">
                                                        <button data-{{$device->id}}-min="{{$breaking->parse_price('min')[0]}}"
                                                                ...
                                                                data-value="finish"
                                                                data-btn="result"
                                                                data-breaking="Да, исправен"
                                                                class="nav_btn display_target"
                                                        >Да, исправен
                                                        </button>
                                            ...
                                            <div class="row">
                                                <div class="col-xs-12"><p class="callback8">Не знаете, как ответить?</p>
                                                </div>
                                            </div>
                                        </div>
                                @endif
                                ...
                                <div class="col-xs-12">
                                    <div class="form">
                                        <form id="frm2"
                                              ...
                                              class="contactform2"
                                        >
                                            <div class="zag">Введите свои данные ниже, наш менеджер свяжется с Вами в
                                                течение 5 минут для консультации и ответов на все Ваши вопросы.
                                            </div>
                                            <input id="phone" type="text" name="phone" placeholder="+7 (___) ___-__-__"
                                                   class="form-control phone validate[required]"
                                            ><input name="action"
                                                    ...
                                                    type="hidden"
                                            >
                                            <button>Зафиксировать цену<img src="{{asset('uploads/')}}/svg/arrow-btn.svg" alt="с">
                                            </button>
                                            <div id="confidential" class="minconf">
                                                Нажимая на кнопку «<span class="textbtn"></span>», я даю
