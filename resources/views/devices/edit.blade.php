                            ...
                            <div class="col-xs-6">
                                ...
                                <form method="post" action="{{route('devices.update', $device->id)}}">
                                    ...
                                    <div class="form-group repeater">
                                        ...
                                        <div data-repeater-list="breakings" class="sortable-list">
                                            ...
                                            @if ($device->breakings->isNotEmpty())
                                                ...
                                                @foreach ($device->breakings as $breaking_device)
                                                    <div class="form-group form-inline" data-repeater-item>
                                                        ...
                                                        <input class="no-repeat"
                                                               type="text"
                                                               hidden
                                                               name="breaking_id"
                                                               value="{{$breaking_device->pivot->breaking_id}}"
                                                        >
                                                        <input name="min_price"
                                                               ...
                                                               value="{{$breaking_device->pivot->min_price}}"
                                                        >
                                                        <input name="max_price"
                                                               ...
                                                               value="{{$breaking_device->pivot->max_price}}"
                                                        >
                                                        <button class="btn btn-danger" data-repeater-delete>
                                                            <i class="fa fa-times"></i>
                                                        </button>
                                                            <i class="fa fa-fw fa-bars sort-handle"
                                                               aria-hidden="true"
                                                            ></i>
                                                    </div>
                                                @endforeach
